...
VALUES
    ...
    ('pro_wagdbqiksn', 28.6, 'black and white mocha'),
    (
        'pro_oh6bbtwr3u',
        12.03,
    ...
    ('pro_4wmlrlc9qj', 23.7, 'blonde caffe americano'),
    (
        'pro_mw31we3i7z',
        8.53,
    ...
    ('pro_ky3x7wsaop', 13.8, 'blonde caffe latte'),
    (
        'pro_7avbm8uh2i',
        25.93,
    ...
    ('pro_1d8e2q4l94', 19.78, 'blonde cappuccino'),
    (
        'pro_k35hjk0ff3',
        6.29,
    ...
    ('pro_ihduewwbck', 21.59, 'blonde eggnog latte'),
    (
        'pro_1ci5jltliy',
        13.81,
    ...
    ('pro_7ldt9c2fe8', 12.44, 'blonde flat white'),
    (
        'pro_lty5caabmr',
        25.28,
    ...
    ('pro_yl2bnxyxlc', 18.83, 'blonde juniper latte'),
    (
        'pro_ojj0f3i6wu',
        25.98,
    ...
    ('pro_xpdrkmf69u', 7.45, 'blonde roast'),
    (
        'pro_4rqio2dxkx',
        9.21,
    ...
    ('pro_wcphax2mb6', 7.88, 'blonde vanilla latte'),
    (
        'pro_njdp6mehh4',
        5.59,
    ...
    ('pro_drk6bwyiti', 21.63, 'bottled caffe latte'),
    ('pro_o7o6v9mno6', 24.71, 'bottled caffe mocha'),
    ('pro_cgezbad1jo', 19.41, 'bottled cappuccino'),
    (
        'pro_rlha8fpumf',
        23.51,
    ...
    ('pro_0q3fkf3rd5', 7.64, 'bottled cordusio'),
    (
        'pro_ic0c09mhnz',
        29.95,
    ...
    ('pro_gulcpvknmp', 7.95, 'bottled eggnog latte'),
    ('pro_1grorkkqfe', 17.41, 'bottled espresso'),
    (
        'pro_6ui6etw7p0',
        13.55,
    ...
    ('pro_gmtex7wizz', 25.41, 'bottled flat white'),
    (
        'pro_r9qef74tlk',
        12.14,
    ...
    ('pro_69qzhf5f1r', 15.95, 'bottled juniper latte'),
    (
        'pro_fjmn65qqaa',
        7.09,
    ...
    ('pro_hfr1vgpi8d', 17.25, 'bottled pink drink'),
    (
        'pro_mko8zees8l',
        17.62,
    ...
    ('pro_4jq71ws1tm', 25.19, 'bottled skinny mocha'),
    (
        'pro_lod691ufc1',
        15.72,
    ...
    ('pro_pgke1fu5lk', 10.27, 'bottled vanilla latte'),
    (
        'pro_77t819sdo9',
        8.46,
    ...
    ('pro_lnct8xybkl', 19.16, 'bottled violet drink'),
    (
        'pro_pwp73iwd1g',
        7.76,
    ...
    ('pro_qj3pr3aa98', 27.43, 'caffe americano'),
    (
        'pro_ys6fy30rky',
        24.7,
    ...
    ('pro_wr6kd31ct1', 11.68, 'caffe latte'),
    (
        'pro_jt9mrx3pk1',
        13.62,
        'caffe latte frappuccino'
    ),
    ('pro_bo60v3txax', 25.79, 'caffe latte refresher'),
    ('pro_aopeevk6os', 22.92, 'caffe misto'),
    (
        'pro_0sh00kkada',
        29.76,
        'caffe misto frappuccino'
    ),
    ('pro_9g7igsprgy', 7.13, 'caffe mocha'),
    (
        'pro_4ww67is65l',
        13.7,
        'caffe mocha frappuccino'
    ),
    ('pro_nmj61uu25o', 26.99, 'caffe mocha refresher'),
    ('pro_vyr9opmzjc', 5.65, 'cappuccino'),
    ('pro_jzqe9pvcgu', 13.4, 'cappuccino frappuccino'),
    ('pro_ykgvljspdf', 29.36, 'cappuccino refresher'),
    (
        'pro_fr80cf211z',
        18.67,
        'caramel brule creme frappuccino'
    ),
    ('pro_tpxm5h9km2', 12.71, 'caramel brule latte'),
    (
        'pro_27sp40n2w1',
        28.25,
    ...
    ('pro_f5u2yjsd2q', 8.34, 'caramel macchiato'),
    (
        'pro_7ef8d0apyd',
        19.48,
    ...
    ('pro_hfdzyu2jtt', 6.98, 'chestnut praline latte'),
    (
        'pro_ygeg31q0rt',
        20.55,
    ...
    ('pro_r6bfgc84n9', 20.89, 'cinnamon dolce latte'),
    (
        'pro_tr17w5o2kp',
        11.73,
    ...
    ('pro_18eo611t1o', 7.34, 'clover brewed coffee'),
    (
        'pro_u8d0jnmb2a',
        15.03,
        'clover brewed coffee frappuccino'
    ),
    ('pro_q1s6dzxgzp', 20.52, 'coffee traveler'),
    (
        'pro_nlka856e6b',
        29.39,
        'coffee traveler frappuccino'
    ),
    ('pro_6xm6g8s77z', 13.45, 'cold brew coffee'),
    (
        'pro_fz8w0j9376',
        20.31,
    ...
    ('pro_6owl1ca8a9', 9.8, 'cordusio'),
    ('pro_33jnxtt6le', 9.7, 'cordusio frappuccino'),
    ('pro_wp0in2n4gi', 6.43, 'cordusio refresher'),
    (
        'pro_ns7jpw4bvd',
        17.42,
    ...
    ('pro_v0yxiv0xaa', 24.21, 'eggnog latte'),
    (
        'pro_n2t6tq3mvi',
        26.33,
    ...
    ('pro_fsdwe6l92n', 8.95, 'espresso'),
    ('pro_gtn7we6jjk', 27.97, 'espresso con panna'),
    (
        'pro_s8o0emwp9j',
        14.69,
    ...
    ('pro_uut1y6o6cp', 20.65, 'espresso frappuccino'),
    ('pro_z2u45hgg1s', 24.83, 'espresso macchiato'),
    (
        'pro_0t94bu74je',
        5.76,
    ...
    ('pro_nsj5y6a80j', 20.16, 'espresso refresher'),
    (
        'pro_7eo6xwan1k',
        14.25,
    ...
    ('pro_qjwcm7w14z', 26.12, 'featured dark roast'),
    (
        'pro_hukcgd2iic',
        27.86,
        'featured dark roast frappuccino'
    ),
    ('pro_q9jwrezqrp', 8.4, 'flat white'),
    (
        'pro_dspu9b2kyw',
        11.97,
        'flat white frappuccino'
    ),
    ('pro_nlkdjm2u7h', 28.85, 'flat white refresher'),
    ('pro_7h2tq1f4g5', 8.26, 'foam cascara cold brew'),
    (
        'pro_4ab4nxmtkc',
        26.87,
    ...
    ('pro_bwmzuuegxo', 29.37, 'foam cold brew'),
    (
        'pro_dwyombiwme',
        22.91,
    ...
    ('pro_nqqi201vmp', 28.73, 'gingerbread latte'),
    (
        'pro_dgnegjrcmm',
        18.37,
    ...
    ('pro_cahsz9aq91', 6.35, 'iced caffe americano'),
    (
        'pro_nv9krd5o43',
        15.39,
    ...
    ('pro_5i6c05ixaq', 14.58, 'iced caffe latte'),
    (
        'pro_piypp0fe9x',
        22.98,
    ...
    ('pro_d67iotoajj', 24.78, 'iced caffe mocha'),
    (
        'pro_eqmdto8w4o',
        29.77,
    ...
    ('pro_m219m9sqno', 11.94, 'iced cappuccino'),
    (
        'pro_4tc3hxu1wh',
        28.95,
    ...
    ('pro_a1a9wnh9gj', 9.28, 'iced coffee'),
    ('pro_2qul0am2ie', 20.39, 'iced coffee caramel'),
    (
        'pro_99nxrm6lu4',
        5.06,
    ...
    ('pro_lusqifthrv', 20.09, 'iced coffee refresher'),
    (
        'pro_ruta3vi2r1',
        12.89,
    ...
    ('pro_thg27vfl1z', 25.62, 'iced coffee with milk'),
    (
        'pro_i01575j8rx',
        18.71,
    ...
    ('pro_gbico8uqfo', 29.21, 'iced cold brew coffee'),
    (
        'pro_l6jf6mbrq7',
        9.59,
    ...
    ('pro_1ng5av6l26', 25.91, 'iced cordusio'),
    (
        'pro_6vf4tp6k71',
        10.76,
    ...
    ('pro_2a0g42cbi3', 17.41, 'iced eggnog latte'),
    (
        'pro_ntnv0ozo4k',
        17.19,
    ...
    ('pro_9va9nqo0qb', 20.65, 'iced espresso'),
    (
        'pro_yhj198pqav',
        10.02,
    ...
    ('pro_gc0sua3tmd', 9.53, 'iced flat white'),
    (
        'pro_1zcgerbmm6',
        13.31,
    ...
    ('pro_4twvvomkt0', 23.64, 'iced juniper latte'),
    (
        'pro_zr1bldjp6b',
        8.6,
    ...
    ('pro_qrnzdfpuhg', 10.78, 'iced latte macchiato'),
    (
        'pro_ngkty5sujc',
        10.25,
    ...
    ('pro_cw0xhhq6jk', 18.37, 'iced nitro cold brew'),
    (
        'pro_z6h2nt7kha',
        8.07,
        'iced nitro cold brew with sweet cream'
    ),
    ('pro_0ot3vmwvco', 20.36, 'iced nitro lemon fog'),
    ('pro_movlq5jrs0', 29.98, 'iced peppermint mocha'),
    (
        'pro_hr3yarnmyh',
        23.23,
    ...
    ('pro_3ftz9svlce', 23.16, 'iced pink drink'),
    (
        'pro_ewng8nqgt7',
        20.25,
    ...
    ('pro_jngk4zvfto', 27.21, 'iced shaken sweet tea'),
    (
        'pro_24jnix1s2t',
        12.3,
    ...
    ('pro_itdard1gnq', 18.65, 'iced skinny mocha'),
    (
        'pro_fzd1m7rx3j',
        18.17,
    ...
    ('pro_wekltjzlyh', 20.33, 'iced vanilla latte'),
    (
        'pro_tjy3lhwqda',
        12.76,
    ...
    ('pro_s5milftthi', 16.51, 'iced violet drink'),
    (
        'pro_duh8uzfez0',
        10.55,
    ...
    ('pro_m3mos58ttm', 29.8, 'juniper latte'),
    (
        'pro_zq3dhivls6',
        21.94,
    ...
    ('pro_vbiopjiplu', 27.32, 'latte macchiato'),
    (
        'pro_30m1w0vm4x',
        12.8,
    ...
    ('pro_mdzanp7e4q', 7.99, 'nitro cold brew'),
    (
        'pro_y1qvtqdkn5',
        15.53,
    ...
    ('pro_f4afbw00x0', 10.12, 'nitro lemon fog'),
    (
        'pro_43xa5oxk3r',
        15.51,
    ...
    ('pro_8pclvt6ggw', 16.37, 'peppermint mocha'),
    (
        'pro_al6o0pox6n',
        7.22,
    ...
    ('pro_eyr358t4t0', 13.58, 'pike place roast'),
    (
        'pro_qolkhc6yq5',
        17.3,
        'pike place roast frappuccino'
    ),
    ('pro_vcxtofb6nh', 26.09, 'pink drink'),
    (
        'pro_rij0js1myy',
        15.87,
        'pink drink frappuccino'
    ),
    ('pro_j4eno1ihmg', 23.39, 'pink drink refresher'),
    (
        'pro_duqb67h1ia',
        5.38,
    ...
    ('pro_klwa3wyu1k', 10.11, 'pumpkin spice latte'),
    (
        'pro_xlc6mbpt5w',
        19.9,
    ...
    ('pro_z8btrn13p9', 17.37, 'salted caramel mocha'),
    (
        'pro_rgkolybk6l',
        26.03,
    ...
    ('pro_abl7ztnhet', 7.65, 'shaken sweet tea'),
    (
        'pro_gewwwqs2de',
        11.86,
        'shaken sweet tea frappuccino'
    ),
    ('pro_jn8dfkwtrn', 14.5, 'skinny mocha'),
    (
        'pro_aw4ngfwmvr',
        29.82,
    ...
    ('pro_o0zvgdcyux', 12.46, 'vanilla latte'),
    (
        'pro_agyel9tl1s',
        24.4,
    ...
    ('pro_87d6jwhlrc', 25.15, 'violet drink'),
    (
        'pro_dui1o0dzbu',
        20.8,
        'violet drink frappuccino'
    ),
    ('pro_rbgtpn5o3g', 15.3, 'violet drink refresher'),
    ('pro_xqqeau3deu', 16.59, 'white chocolate mocha'),
    (
        'pro_ttqi5wtizq',
        15.73,
